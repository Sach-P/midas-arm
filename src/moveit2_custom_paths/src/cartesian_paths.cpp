...
void custom_paths::CartesianPathsNode::get_current_state(){
    const moveit::core::JointModelGroup *joint_model_group_arm =
         this->move_group_arm.getCurrentState()->getJointModelGroup(PLANNING_GROUP_ARM);
